  ...
  return (
    <Link to="/" className={`flex items-center gap-2 ${className}`} aria-label="Plus2 Pharmacy home">
      ...
      <div className="leading-tight">
        <div className="text-lg font-extrabold tracking-tight text-primary">Plus<span className="text-primary-dark">2</span><span className="text-foreground"> Pharmacy</span></div>
