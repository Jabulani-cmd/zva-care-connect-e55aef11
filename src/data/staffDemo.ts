...
export const STAFF_EXPENSES: StaffExpense[] = [
  ...
  },
  {
    id: "EXP-2026-0040",
    category: "Utilities",
    description: "ZESA prepaid — Harare CBD branch",
    amount: 220.0,
    date: "Yesterday",
  ...
  },
  {
    id: "EXP-2026-0037",
    category: "Rent",
    description: "Harare CBD branch rent — June",
    amount: 2400.0,
    date: "1 week ago",
...
export const STAFF_SYSTEM_USERS: StaffSystemUser[] = [
  {
    id: "STF-0000",
    name: "Tendai Moyo",
    email: "sysadmin@plus2pharmacy.co.zw",
    role: "system_admin",
    branch: "Head Office",
    status: "Active",
    lastLogin: "5 min ago",
  },
  {
    ...
    email: "admin@plus2pharmacy.co.zw",
    role: "super_admin",
    branch: "Head Office",
    status: "Active",
  ...
  },
  {
    id: "STF-0042",
    name: "Dr. Aisha Moosa",
    email: "pharmacist@plus2pharmacy.co.zw",
    role: "pharmacist",
    branch: "Harare CBD",
    status: "Active",
  ...
  },
  {
    ...
    email: "manager@plus2pharmacy.co.zw",
    role: "store_manager",
    branch: "Harare CBD",
    status: "Active",
  ...
  },
  {
    id: "STF-0073",
    name: "Lungelo Zulu",
    email: "dispatcher@plus2pharmacy.co.zw",
    role: "dispatcher",
    branch: "Harare CBD",
    status: "Active",
    lastLogin: "2 min ago",
  },
  {
    ...
    email: "cashier@plus2pharmacy.co.zw",
    role: "cashier",
    branch: "Harare CBD",
    status: "Active",
  ...
  },
  {
    id: "STF-0056",
    name: "Sipho Mahlangu",
    email: "inventory@plus2pharmacy.co.zw",
  ...
  },
  {
    id: "STF-0102",
    name: "Tendai Nyathi",
    email: "tendai.n@plus2pharmacy.co.zw",
    role: "cashier",
    branch: "Bulawayo",
    status: "Locked",
  ...
  },
  {
    id: "STF-0099",
    name: "Patience Moyo",
    email: "patience.m@plus2pharmacy.co.zw",
    role: "pharmacist",
    branch: "Bulawayo",
    status: "Invited",
    lastLogin: "Never",
